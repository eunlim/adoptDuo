...
<script>
	...
	var positions = [ // 마커의 위치
		new kakao.maps.LatLng(36.682537, 126.849548), 
		new kakao.maps.LatLng(36.682709, 126.849526), 
		new kakao.maps.LatLng(36.683295, 126.849926) 
	], 
	...
	var content = '';
	var overlays = [];            
	var normalImage, overImage, clickImage = null;
	var marker = null;
	...
	function addMarker(position, normalOrigin, overOrigin, clickOrigin, i) {
	    ...
	    // 기본 마커이미지, 오버 마커이미지, 클릭 마커이미지를 생성합니다
	    	normalImage = createMarkerImage(markerSize, markerOffset, normalOrigin),
	    ...
	    content = '<div class="wrap">' + 
			        ...
			        '        <div class="title">' + 
			        '            카카오 스페이스닷원' + 
			        '            <div class="close" onclick="closeOverlay('+i+', '+null+')" title="닫기"></div>' + 
			        '        </div>' + 
			        '        <div class="body">' + 
			        '            <div class="img">' +
